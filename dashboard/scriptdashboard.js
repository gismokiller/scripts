    ...
    const allBranches = [
        {value: "Efectimundo_Atizapan_Plaza_Cristal", label: "Atizapan Plaza Cristal"},
        {value: "Efectimundo_Azcapotzalco", label: "Azcapotzalco"},
        {value: "Efectimundo_Cancun_MultiPlaza_Arco_Norte", label: "Cancun Arco Norte"},
        ...
        {value: "Efectimundo_Chimalhuacan_Barrio_Artesanos", label: "Chimalhuacan Artesanos"},
        {value: "Efectimundo_Chimalhuacan_Centro", label: "Chimalhuacan Centro"},
        {value: "Efectimundo_Chimalhuacan_Las_Torres", label: "Chimalhuacan Las Torres"},
        ...
        {value: "Efectimundo_Coyoacan_Plaza_Cantil", label: "Coyoacan Plaza Cantil"},
        ...
        {value: "Efectimundo_Ecatepec_San_Agustin", label: "Ecatepec San Agustin"},
        {value: "Efectimundo_Ecatepec_Santa_Clara", label: "Ecatepec Santa Clara"},
        {value: "Efectimundo_Galerias_Chalco", label: "Galerias Chalco"},
        ...
        {value: "Efectimundo_Heroes_Chalco", label: "Heroes Chalco"},
        {value: "Efectimundo_Heroes_Ixtapaluca", label: "Heroes Ixtapaluca"},
        {value: "Efectimundo_Heroes_Tecamac_1_Seccion", label: "Heroes Tecamac 1"},
        {value: "Efectimundo_Heroes_Tizayuca", label: "Heroes Tizayuca"},
        ...
        {value: "Efectimundo_Nezahualcoyotl_Adolfo_Lopez_Mateos", label: "Neza Lopez Mateos"},
        ...
        {value: "Efectimundo_Nicolas_Romero", label: "Nicolas Romero"},
        {value: "Efectimundo_Oaxaca_Plaza_Bella", label: "Oaxaca Plaza Bella"},
        {value: "Efectimundo_Patio_Texcoco", label: "Patio Texcoco"},
        {value: "Efectimundo_Playa_del_Carmen_Plaza_Sofia", label: "Playa Carmen Plaza Sofia"},
        {value: "Efectimundo_Plaza_Atizapan", label: "Plaza Atizapan"},
        {value: "Efectimundo_Plaza_Centenario", label: "Plaza Centenario"},
        {value: "Efectimundo_Plaza_Chimalhuacan", label: "Plaza Chimalhuacan"},
        ...
        {value: "Efectimundo_Portal_Tultitlan", label: "Portal Tultitlan"},
        ...
        {value: "Efectimundo_Recursos_Hidraulicos_Ecatepec", label: "Recursos Hidraulicos"},
        ...
        {value: "Efectimundo_Tecamac_Centro", label: "Tecamac Centro"},
        {value: "Efectimundo_Tecamac_Macroplaza", label: "Tecamac Macroplaza"},
        {value: "Efectimundo_Tecamac_Plaza_Bella_Mexiquense", label: "Tecamac Plaza Bella"},
        {value: "Efectimundo_Tecamac_Power_Center", label: "Tecamac Power Center"},
        ...
        {value: "Efectimundo_Tlahuac_San_Lorenzo", label: "Tlahuac San Lorenzo"},
        {value: "Efectimundo_Tlahuac_Zapotitlan", label: "Tlahuac Zapotitlan"},
        ...
        {value: "Efectimundo_Tultitlan", label: "Tultitlan"},
        {value: "Efectimundo_Tultitlan_Lecheria", label: "Tultitlan Lecheria"},
