            ...
            const previewHtml = `
                <div style="background: var(--bg-card); border: 1px solid var(--border); border-radius: 10px; padding: 20px;">
                    ...
                    <div style="display: flex; flex-direction: column; gap: 8px;">
                        <button onclick="confirmGroupPhotoUpdate('${safeGroupId}', '${safeSession}', '${safeImageUrl}', currentRowId)" class="btn btn-primary btn-block" style="font-size: 12px;">Confirmar cambio de foto</button>
