...
async function actionUpdatePhoto(groupId, session, currentUrl, rowId) {
    ...
    fileInput.onchange = async (e) => {
        ...
        statusLog.classList.remove('hidden');
        statusLog.innerHTML = `<div style="display: flex; align-items: center; gap: 12px;"><div class="spinner"></div><span style="color: var(--accent);">Subiendo imagen a Cloudinary...</span></div>`;
        ...
        try {
            ...
            console.log("imageUrl obtained, showing preview...");
            statusLog.style.display = 'block';
            ...
            console.log("Directly calling confirmGroupPhotoUpdate...");
            
            await confirmGroupPhotoUpdate(groupId, session, imageUrl, currentRowId);
