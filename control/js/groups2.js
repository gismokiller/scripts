...
function renderFullAdminTable(groups) {
    ...
    groups.forEach((g, index) => {
        ...
        html += `
        <tr style="cursor: pointer;" onclick="openImageModal('${safeGroupName}', '${safeSessionName}', '${safeUrlImage}', '${g.id_chat_group}')">
            <td>
            ...
            <td style="text-align: center;" onclick="event.stopPropagation()">
                <div style="display: flex; justify-content: center; gap: 8px;">
                    ...
                    <button onclick="actionUpdatePhoto('${g.id_chat_group}', '${g.Nombre_session}', '${safeUrlImage}', this.closest('tr'))" 
                            class="icon-btn"
                            title="Cambiar Foto">
            ...
            const previewHtml = `
                <div style="background: var(--bg-card); border: 1px solid var(--border); border-radius: 10px; padding: 20px;">
                    ...
                    <div style="display: flex; flex-direction: column; gap: 8px;">
                        <button onclick="confirmGroupPhotoUpdate('${safeGroupId}', '${safeSession}', '${safeImageUrl}', null)" class="btn btn-primary btn-block" style="font-size: 12px;">Confirmar cambio de foto</button>
